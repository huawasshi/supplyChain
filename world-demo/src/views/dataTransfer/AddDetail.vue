 ...
 * @LastEditTime: 2022-08-05 13:50:09
 * @LastEditors: yanchenxi
 * @Description: 
 * @FilePath: \frontend\src\views\dataTransfer\AddDetail.vue
-->
<template>
  <div>
      ...
      <div class="row">
        <div class="col col-md-4">
          <bfe-form-item label="迁移数据源类型">
            <bfe-select v-model="form.a5" placeholder="请选择" @change="qyChange">
        ...
        <div class="col col-md-4">
          <bfe-form-item label="目标数据源类型">
            <bfe-select v-model="form.a6" placeholder="请选择" @change="mbChange">
